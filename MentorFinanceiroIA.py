...
def aplicar_estilo():
    ...
    <style>
        ...
        .success-box {
            background-color: #050505; /* Verde claro para sucesso */
...
def exibir_cabecalho():
    ...
    with col2:
        if st.session_state.nome_usuario:
            ...
            st.markdown(f"<p style='text-align: right; margin-bottom: 25px;'>Nível: {st.session_state.nivel} | Pontos: {st.session_state.pontos}</p>", unsafe_allow_html=True)
            medalha_html = ""
